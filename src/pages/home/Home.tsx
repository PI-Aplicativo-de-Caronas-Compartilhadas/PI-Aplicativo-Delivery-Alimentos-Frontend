...
function Home() {
  const categories = [
    ...
    { nome: "Almoço", icon: ForkKnife },
    { nome: "Jantar", icon: BowlSteam },
    { nome: "Lanches", icon: HamburgerIcon },
  ];
  return (
    <div className="w-full bg-white text-spring-green-900 py-8 px-8 flex flex-col items-center">
      <div className="w-full max-w-screen-xl flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-2xl md:text-4x1 text-spring-green-700">
            Pronto para sua próxima refeição saudável?
          </p>
        </div>
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-3 text-xs font-bold text-[#075f2d] bg-[#dcfce7]/70 py-2 px-3.5 rounded-lg w-fit">
              <span className="flex items-center gap-1">
                <Fire size={15} weight="fill" className="text-[#f97316]" /> 450
                kcal
              </span>
              <span>|</span>
              <span>35g Carb</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categories.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-white p-5 rounded-2xl border border-[#bbf7d0] shadow-sm flex flex-col items-center gap-3 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[#4ade80]"
                >
                  ...
                  <span className="font-bold text-2x1 text-[#14532d]">
                    {item.nome}
                  </span>
                </div>
              );
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* --- Grid mais responsivo e fluido em mobile, tablets e desktop--- */}
            ...
            {[
              ...
              >
                ...
                <div className="p-3.5 flex flex-col items-center text-center">
                  ...
                  <span className="text-x1 text-[#0b8e44] font-semibold mt-0.5">
                    {item.kcal}
                  </span>
                </div>
              </div>
